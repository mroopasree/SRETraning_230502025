pipeline {
    ...
    environment {
        ...
        REGION = "ap-south-1"
        REPO_URI = "862848730563.dkr.ecr.ap-south-1.amazonaws.com/roopasree"
    ...
    stages {
        ...
        stage('Push to ECR') {
            steps {
                script {
                    withAWS(credentials: 'ROOPA-CREDS', region: "${REGION}") {
            ...
            steps {
                withCredentials([usernamePassword(credentialsId: "${DOCKER_REGISTRY_CREDENTIALS}", passwordVariable: 'DOCKER_PASSWORD', usernameVariable: 'DOCKER_USERNAME')]) {
                    ...
                    sh """
                        ...
                        docker tag ${DOCKER_IMAGE} mroopasree/${DOCKER_IMAGE}
                        docker push mroopasree/${DOCKER_IMAGE}
                }
            }
        }
